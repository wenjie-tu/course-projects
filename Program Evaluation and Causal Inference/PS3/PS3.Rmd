...
stargazer(model.fe, model.fe, se=list(NULL, cluster.se), 
          ...
          header=F, keep.stat='n', font.size='small')
```
...
stargazer(model1, model2, model3, omit='Constant', 
          keep.stat='n', font.size='small', header=F)
```
